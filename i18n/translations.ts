...
export const en = {
  ...
  requests: {
    ...
    releaseJob: "Release this job",
    markNoShow: "Guest did not show",
    confirmTitle: "Are you sure?",
    confirmCompleteBody:
      "This closes the trip and records it as revenue. Only an admin can undo it.",
...
export const no = {
  ...
  myBookings: {
    ...
    statusAssigned: "Sjåfør tildelt",
    statusInProgress: "På vei",
  ...
  requests: {
    ...
    startTrip: "Start turen",
    completeTrip: "Fullfør turen",
    releaseJob: "Gi fra deg oppdraget",
    markNoShow: "Gjesten møtte ikke",
    confirmTitle: "Er du sikker?",
    confirmCompleteBody:
      "Dette avslutter turen og fører den som inntekt. Bare en administrator kan angre.",
